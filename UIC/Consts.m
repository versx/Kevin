...
BOOL DEFAULT_ENABLE_ACCOUNT_MANAGER = true;
BOOL DEFAULT_ULTRA_QUESTS = true;
BOOL DEFAULT_DEPLOY_EGGS = true;
BOOL DEFAULT_NEARBY_TRACKER = true;
BOOL DEFAULT_AUTO_LOGIN = true;
